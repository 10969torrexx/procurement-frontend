...
class APPCSE extends Controller
{
    /**
  ...
  public function app_cse_index(Request $request){
    try {
      ...
      return view('pages.bac.app_cse.app_cse', compact('response','campus'));
    } catch (\Throwable $th) {
      throw $th;
    }
  }

  public function app_cse_uwide_index(Request $request){
    try {
      $campus = 0;
      $response = DB::table('app_cse')
                    ->whereNull('deleted_at')
  ...
  */
  ...
  /* Endorse Uploaded app cse
  * - this will delete the uploaded app
  * - based on: Employee id, campus, department_id
  */
  public function endorse_uploaded_app_cse(Request $request) {
    try {
        $response = \DB::table('app_cse')
        ...
        # end
        return back()->with([
            'success'   => 'Uploaded app successfully Endorse!'
        ]);
    } catch (\Throwable $th) {
        return view('pages.error-500');
        // throw $th;
  ...
  public function get_upload_app_cse(Request $request) {
      try {
          ...
          $response = \DB::table('app_cse')
              ...
              ->get();
          # return page
          return view('pages.bac.app_cse.app_cse', compact('response'));
      } catch (\Throwable $th) {
          throw $th;
          return view('pages.error-500');
      }
