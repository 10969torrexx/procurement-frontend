                        ...
                        <div class="table-responsive">
                            <table class="table nowrap zero-configuration" id="account-table">
                                ...
                                <tbody id="table-account-tbody">
                                    ...
                                    @else
                                        <?php $ctr=1; ?>
                                        @foreach($mandatory_expenditures['data'] as $data)
                                            <tr id = "{{$ctr}}">
                                                <td>
                                                    <div class="dropdown">
                                                        <span
...
@include('pages.budgetofficer.mandatory-expenditure-modal')
@include('pages.budgetofficer.update-mandatory-expenditure-modal')
...
{{-- employee JS --}}
<script src="{{asset('js/budgetofficer/mandatory-expenditure.js')}}"></script>
