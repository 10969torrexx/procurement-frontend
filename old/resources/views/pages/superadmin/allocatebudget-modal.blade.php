                ...
                <div class="row" hidden>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <fieldset class="form-group">
                          ...
                          <input type="text" class="start_date form-control"value ="{{ date('M j, Y', strtotime($deadline['start_date'])) }}" disabled>
                      </fieldset>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <fieldset class="form-group">
                    ...
                    <div class="col-md-12">
                        <fieldset class="form-group">
                            ...
                            <select id="year" class="year form-control" required>
                                <option value="" selected disabled>-- Select Procurement Type First --</option>
                            </select>
                        </fieldset>
                    </div>
                </div>
