               ...
               <div class="row" >
                ...
                <div class="row" >
                    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <select class="update_mandatory_expenditures form-control" id="update_mandatory_expenditures" data-placeholder="-- Select Mandatory Expenditures --"  multiple="multiple" required>
                                <option value="" selected disabled>-- Select Mandatory Expenditures --</option>
                                {{-- <option value="{{$aes->encrypt(1)}}">GoP</option>
                                <option value="{{$aes->encrypt(2)}}">Foreign</option>
                                <option value="{{$aes->encrypt(3)}}">Special Purpose Fund</option>
                                <option value="{{$aes->encrypt(4)}}">Corporate Budget</option>
                                <option value="{{$aes->encrypt(5)}}">Income</option> --}}
                            </select>
                    </div>
                </div>
                {{-- <div class="row">
