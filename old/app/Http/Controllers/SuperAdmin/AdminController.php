...
class AdminController extends Controller
{
    ...
    public function mandatory_expenditures_index(){
        ...
        $mandatory_expenditures =  Http::withToken(session('token'))->get(env('APP_API'). "/api/mandatory_expenditures/mandatory_expenditures_index")->json();
            ...
            return view('pages.superadmin.mandatory-expenditures-index',compact('mandatory_expenditures'), [
                'pageConfigs'=>$pageConfigs,
                'breadcrumbs'=>$breadcrumbs,
                'error' => $error,
            ]);
    ...
    public function setDeadlineIndex(){
        ...
        $ppmp_deadline =  Http::withToken(session('token'))->get(env('APP_API'). "/api/ppmp_deadline/ppmp_deadline_index")->json();
            // dd($ppmp_deadline);
            $error="";
            ...
            return view('pages.superadmin.setdeadline-index',compact('ppmp_deadline'), [
                'pageConfigs'=>$pageConfigs,
                'breadcrumbs'=>$breadcrumbs,
                'error' => $error,
            ]);
