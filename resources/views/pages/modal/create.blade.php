        ...
        <div class="modal-body" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <fieldset class="form-group">
                            ...
                            <select class="selectcampus form-control" value = "">
                                <option value="" selected disabled>Select Campus</option>
                                <option value="{{$aes->encrypt(1)}}">Main</option>
                                <option value="{{$aes->encrypt(2)}}">Maasin</option>
                                <option value="{{$aes->encrypt(3)}}">Tomas Oppus</option>
                                <option value="{{$aes->encrypt(4)}}">Bontoc</option>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <fieldset class="form-group">
                            ...
                            <select class="selectrole form-control" value = "">
                ...
                <div class="row" hidden>
                    ...
                    <fieldset class="form-group">
                        ...
                        <input type="text" class="rolename form-control"  placeholder="Role Name" value = "">
                    </fieldset>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <fieldset class="form-group">
                        ...
                        <input type="text" class="campus form-control"  placeholder="Campus" value="" required>
                    </fieldset>
                    </div> 
                </div>
