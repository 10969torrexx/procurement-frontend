<div class="modal fade" id="edit_logo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <div class="modal-body">
                <form {{-- action="{{ route('update-logo') }}" --}}id ="OtherLogo" method="post" enctype="multipart/form-data">
                    ...
                    <div class="" style="margin-top: 1%;">
                        ...
                        <input type="hidden" name="campuslogoid" id="Logo" class="form-control Logo" value="" >
                    </div>
                    {{-- campusLogo --}}
