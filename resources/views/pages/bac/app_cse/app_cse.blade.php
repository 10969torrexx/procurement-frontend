                  ...
                  <div class="row mr-1" >
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item" href="/bac/app_cse">Main Campus</a></li>
                        <li><a class="dropdown-item" href="/bac/app_cse_uwide">University Wide</a></li>
                      </ul>
                    </div>
                  </div> 
                @endif
                                      ...
                                      @foreach ($response as $item)
                                        @if ($item->project_category == 1)
                                          ...
                                          <tr id="t-tr">
                                            ...
                                            <td id="t-td">{{ (new GlobalDeclare)->Campus($item->campus) }} Campus</td>
                                            ...
                                            @if (session('role') == 10)
                                              <td id="t-td" class="text-nowrap">
                                                <div class="badge badge-pill badge-light-{{ (new GlobalDeclare)->endorse_color($item->endorse,"bg") }} mr-1">{{ (new GlobalDeclare)->endorse($item->endorse) }}</div>
                                              </td>
                                            @endif
                                            <td id="t-td">
                                              <div class="dropdown">
                                                  ...
                                                  <div class="btn dropdown-menu dropdown-menu-left ">
                                                      ...
                                                      <a href= "{{ route('download_appcse', ['id' => (new AESCipher)->encrypt($item->id) ]) }}" class="dropdown-item">
                                                        <i class="fa-solid fa-file-arrow-down mr-1"></i>Download
                                                      </a>
                                                      @if (session('role') == 10)
                                                        @if ($item->endorse == 0)
                                                          <a href= "{{ route('endorse_appcse', ['id' => (new AESCipher)->encrypt($item->id) ]) }}" class="dropdown-item bg-rgba-warning text-warning ">
                                                            <i class="fa-solid fa-check mr-1 text-warning"></i>Endorse
                                                          </a>
                                                        @endif
                                                      @endif
                                                  </div>
