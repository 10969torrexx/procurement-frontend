                        ...
                        <div class="table-responsive">
                            <table class="table nowrap zero-configuration" id="account-table">
                                ...
                                <tbody id="table-account-tbody">
                                    ...
                                    @else
                                        <?php $ctr=1; ?>
                                        @foreach($ppmp_deadline['data'] as $data)
                                            <tr id = "{{$ctr}}">
                                                <td>
                                                    <div class="dropdown">
                                                        <span
...
@include('pages.superadmin.setdeadline-modal')
@include('pages.superadmin.update-deadline-modal')
...
{{-- employee JS --}}
<script src="{{asset('js/superadmin/deadline.js')}}"></script>
