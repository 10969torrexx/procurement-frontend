...
<section id="dashboard-ecommerce">
    <div class="card">
        ...
        <div class="table-responsive">
                <a href="/supervisor/indicative"><<- {{ $data[0]->title }}</a>
    ...
    @include('pages.supervisor.indicative.supervisor_reject_all_ppmp_modal')
    @include('pages.supervisor.indicative.supervisor_disapproved_ppmp_modal')
</section>
