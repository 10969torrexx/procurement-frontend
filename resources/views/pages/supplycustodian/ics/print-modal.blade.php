...
<div class="modal fade" id="printModalics" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
      <div class="modal-content">
                    ...
                    <table style="border:1px solid black">
                        <thead>
                            ...
                            <tr style="border: 0">
                                ...
                                <td colspan="2" class="Ics">ICS No.: {{-- {{substr($property->DateIssued, 0, 7)."-".str_pad($property->PARNo, 4, "0", STR_PAD_LEFT) }} --}}</td>
                            </tr>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td colspan="4" style="border-top : none;">
                                    <div style="text-align: center; font-size: 20px; font-weight: 900;border-bottom: 1px solid black; text-transform: uppercase; margin-top:30px" class="IssuedName"><br></div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary closeIcs" data-dismiss="modal">Close</button>
