                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4" style="border-top : none;">
                                                <div style="text-align: center; font-size: 20px; font-weight: 900;border-bottom: 1px solid black; text-transform: uppercase; margin-top:30px" class="IssuedName"><br>{{  $par->Issuedby }}</div>
