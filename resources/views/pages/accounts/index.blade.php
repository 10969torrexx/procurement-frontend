                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-left">
                                                            <a class="dropdown-item" href = "#" data-flag = "<?=$aes->encrypt('accounts')?>" data-button = "<?=$aes->encrypt('edit')?>" data-id = "<?=$aes->encrypt($data['id'])?>" data-toggle = "modal" data-target = "#allModal"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                            <a class="dropdown-item hrefdelete" ctr = "<?=$ctr?>" button = "<?=$aes->encrypt('delete')?>" flag = "<?=$aes->encrypt('accounts')?>" href = "<?=$aes->encrypt($data['id'])?>">
