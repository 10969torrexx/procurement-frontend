                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                            <div id="printThis">
                                <div style="text-align: center; font-weight: 900"><H3>INVENTORY CUSTODIAN SLIP</H3></div>
                                <table style="border:1px solid black">
                                    ...
                                    <tr style="border: 0">
                                        ...
                                        <td colspan="4">{{$fund}}</td>
                                        <td colspan="2">ICS No.: {{substr($property->DateIssued, 0, 7)."-".str_pad($property->PARNo, 4, "0", STR_PAD_LEFT)}}</td>
                                    </tr>
                                    </tr>
                                        <tr style="text-align: center">
                                            <td rowspan="2" style="width: 5%">Qty</td>
                                            <td rowspan="2" style="width: 5%">Unit</td>
                                            <td colspan="2" style="width: 26%">Amount</td>
                                            <td rowspan="2" style="width: 10%">Date of Acquisition</td>
                                            <td rowspan="2" style="width: 34%">Description</td>
                                            <td rowspan="2" style="width:10%">Inventory<br>Item No.</td>
                                            <td rowspan="2" style="width:10%">Estimated<br>Useful Life</td>
                                        </tr>
                                        <tr style="text-align: center">
                                            <td style="width: 13%">Unit Cost</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div style="text-align: center; font-size: 20px; font-weight: 900;border-bottom: 1px solid black"><br><?=strtoupper($subs[0]->EmployeeName)?></div>
                                            <div style="text-align: center;">Signature Over Printed Name of End User</div>

                                            <div style="text-align: center; font-size: 20px; font-weight: 900;border-bottom: 1px solid black"><br><?=$subs[0]->EmpPositionTitle?></div>
                                            <div style="text-align: center;">Position/Office</div>
                                            <div style="text-align: center;text-decoration: underline;"><?=date('F j, Y')?></div>
                                            <div style="text-align: center;">Date</div>    
