                                    ...
                                    @else
                                        ...
                                        @foreach($pr as $data)
                                            <tr id = "{{$ctr}}">
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-left">
                                                            <a class="dropdown-item" ctr = "<?=$ctr?>" href = "{{ route('pr_routing_slip', ['id' => $aes->encrypt($data->id)]) }}">
                                                                <i class="bx bx-task mr-1"></i>Route Slip</a>
                                                        </div>
                                                    </div>   
                                                </td>
                                                <td>{{$data->pr_no }}</td>
                                                ...
                                                @endif
                                                <td>{{ date('M. j, Y', strtotime($data->approved_at))}}</td>
                                            </tr>
                                            <?php $ctr = $ctr + 1 ?>
                                        @endforeach
                                   @endif
