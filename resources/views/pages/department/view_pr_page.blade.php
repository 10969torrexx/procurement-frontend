                        ...
                        <table class="PR">
                          <thead class="head1">
                            ...
                            <tr>
                              ...
                              <td style="border-top: none"><div class="fund_source_input" value="" style="margin-top:2%;border-bottom:1px solid black;text-align:left"></div></td>
                            </tr>
                            <tr>
                              ...
                              <td colspan="4" style="border-bottom : none;border-top : none;text-align:left;">
                                <div class="col-sm-12" >
                                  <div style="float:left;height:100%;width:50%;text-align:left;"></div>
                              ...
                              <td style="border-bottom: none">
                                ...
                                <div style="width:80%;float:left;border-bottom:1px solid black"></div>
                              </td>
                            </tr>
                            <tr>
