    ...
    <div class="card">
        ...
        <div class="table-responsive">
            ...
            <div class="col-md-12 text-right">
                <a href="/admin/pending_ppmps_index"><button type="button" class="btn btn-primary col-md-1 mt-1 back" data-id="{{ $data[0]->pt_id }}">Back</button></a>
                <button type="button" class="btn btn-success col-md-1 mt-1 ppmpDone" data-id="{{ $data[0]->pt_id }}">Done</button>
            </div>
        </div>
    </div>
    </div>
    @include('pages.admin.supervisor_disapproved_ppmp_modal')
</section>
...
<script src="{{asset('js/admin/supervisor.js?id=7')}}"></script>
@endsection
