  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body " >
        ...
        <select id="update_mode_of_procurement" class="form-select form-control update_mode_of_procurement"  aria-label="Default select example">
          {{-- <option id="mode_of_procurement" value="" selected></option> --}}
          <option disabled>--------------------------------------------------------------------------</option>
        </select>
