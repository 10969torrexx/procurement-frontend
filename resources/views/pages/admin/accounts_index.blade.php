            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        <a href = "#" class = "btnAddUser btn btn-success round mr-1 mb-1" data-toggle = "modal" data-target = "#AddUserModal"><i class="bx bx-plus"></i> New Account</a>
...
@include('pages.admin.add_account_modal')
@include('pages.admin.update_account_modal')
...
{{-- employee JS --}}
<script src="{{asset('js/admin/account.js?id=1')}}"></script>
