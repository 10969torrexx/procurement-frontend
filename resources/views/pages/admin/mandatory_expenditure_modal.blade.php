    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document" id = "modalSize">
      ...
      <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <fieldset class="form-group">
                          ...
                          <input type="text" id="mandatory_expenditure" class="mandatory_expenditure form-control" placeholder="Enter Mandatory Expenditure" value ="" required autofocus>
                      </fieldset>
                    </div>
                  </div>
        </div>
        ...
        <div class="modal-footer" id = "footModal">
            ...
            <button type="submit" class="btn btn-primary ml-1 btnAddMandatoryExpenditure">
