        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Signed PPMPs</h4>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table nowrap zero-configuration" id="account-table">
                                ...
                                {{-- <tbody id="table-account-tbody">
                                    ...
                                    @else
                                        <?php $ctr=1; ?>
                                        @foreach($allocated_budgets as $data)
                                            <tr id = "{{$ctr}}">
                                                <td>
                                                    <div class="dropdown">
                                                        <span
                                                ...
                                                <td>{{$data['fund_source_id']}}</td>
                                                <td>Php {{$data['allocated_budget']}}</td>
...
@include('pages.budgetofficer.allocatebudget-modal')
@include('pages.budgetofficer.update-allocatebudget-modal')
...
{{-- employee JS --}}
<script src="{{asset('js/budgetofficer/allocatebudget.js')}}"></script>
